							...
							<div class="table-responsive bg-white">
								<table class="table mb-0">
									...
									<tbody>
										<%
										try {
											System.out.println("This is pattern value in search page111 :"+request.getParameter("pattern"));
											//String pattern = request.getParameter("pattern");
											//System.out.println("This is pattern value in search page :"+pattern);
											//session.setAttribute("ctPage", pageNo);
											DbCon db = new DbCon();
											List<User> list = db.getSearchUsers(request.getParameter("pattern"));
											for (User user : list) {
										%>
										<tr>
						...
						<nav class="page d-flex" aria-label="Page navigation example">
							<ul class="pagination">
								...
								<li class="page-item"><a class="page-link"
									href="userlist.jsp?page=<%=0%>"> <%=1%></a></li>
								<%
